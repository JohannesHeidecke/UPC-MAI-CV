...
\HRule \\[0.4cm]
{ \huge \bfseries Bag of Words (BOW) for Object Recognition}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
{\large January 2017}\\[3cm] % Date, change the \today to a set date if you want to be precise
