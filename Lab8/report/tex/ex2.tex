...
\begin{figure}[!hbt]
\centering
\subfigure[$ \mathrm{maxsteps} = 0.02 $]{\includegraphics[width=45mm]{img/ex2/bird_segmentated_1x.png}}
\subfigure[$ \mathrm{maxsteps} = 0.01 $]{\includegraphics[width=45mm]{img/ex2/bird_segmentated_half.png}}
\subfigure[$ \mathrm{maxsteps} = 0.4 $]{\includegraphics[width=45mm]{img/ex2/bird_segmentated_quarter.png}}
